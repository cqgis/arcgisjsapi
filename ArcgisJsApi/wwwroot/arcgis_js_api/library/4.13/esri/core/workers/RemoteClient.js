define(["require", "exports", "../Error", "../promiseUtils", "./utils", "../../views/support/Scheduler"], function (require, exports, EsriError, promiseUtils_1, utils_1, Scheduler_1) {
    ...
    var RemoteClient = /** @class */ (function () {
        ...
        RemoteClient.prototype._onInvoke = function (message) {
            ...
            if (!promiseUtils_1.isThenable(resultOrPromise)) {
                ...
                // TODO remove after IPromise migration
