define(["require", "exports", "../../core/promiseUtils", "../2d/tiling/enums", "./WorkerTile", "./style/StyleRepository"], function (require, exports, promiseUtils, enums_1, WorkerTile, StyleRepository) {
    /**
    ...
    var WorkerTileHandler = /** @class */ (function () {
        ...
        /**
         * Parse a requested vector-tile
         * @param params {key: string; rotation: number; cacheTile: boolean; sourceName2DataAndRefKey: HashMap<{ refKey: string, protobuff: ArrayBuffer }>} the request information serialized from the main thread.
         * It includes the requested tiles, the reference tiles and the map's rotation.
         ...
         */
        WorkerTileHandler.prototype.createTileAndParse = function (params, options) {
            var _this = this;
            var key = params.key, cacheTile = params.cacheTile;
            var tile = WorkerTile.pool.acquire();
            var sourceName2RefKey = {};
            for (var _i = 0, _a = Object.keys(params.sourceName2DataAndRefKey); _i < _a.length; _i++) {
                var sourceName = _a[_i];
                var refKeyAndProtoBuff = params.sourceName2DataAndRefKey[sourceName];
                sourceName2RefKey[sourceName] = refKeyAndProtoBuff.refKey;
            }
            tile.initialize(key, sourceName2RefKey, this, params.rotation);
            return tile
                .setDataAndParse(params.sourceName2DataAndRefKey, options)
